...
const Login = () => {
  ...
  const handleCapture = async () => {
    ...
    try {
      ...
      const url = "https://codebugged-server.vercel.app/api/auth/login"; // Replace with your backend endpoint
      const method = "POST";
  ...
  return (
    <div className="bg-black min-h-screen h-full flex flex-col gap-4 items-center px-7">
      ...
      <div className="flex items-center flex-col gap-1 w-full">
        <button
          className={`bg-blue-600 font-medium w-full text-white max-w-[500px] min-w-[300px] py-2 rounded-md px-4 ${
